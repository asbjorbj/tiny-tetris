...
bool processKeys() {
  ...
  int joyStickPosX = analogRead(X_pin);
  int joyStickPosY = analogRead(Y_pin);
  int joyStickBtn = digitalRead(SW_pin)*500;
  ...
  else if (joyStickPosX > 1000) {
    movePieceRight();
    delay(100);
  }
  else if (joyStickPosY > 1000) {
    movePieceDown();
    delay(100);
  }
  else if (joyStickPosY < 10) {
    RotatePiece();
    delay(200);
  }
  /*else if (joyStickBtn == 0) {
    movePieceDown();
  }*/
  else {
      acceleration = 0; 
